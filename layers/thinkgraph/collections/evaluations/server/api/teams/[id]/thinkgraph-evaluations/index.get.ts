...
import { getAllThinkgraphEvaluations, getThinkgraphEvaluationsByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getThinkgraphEvaluationsByIds(team.id, ids)
  }

  return await getAllThinkgraphEvaluations(team.id)
})