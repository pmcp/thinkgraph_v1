...
import { getAllThinkgraphCriterias, getThinkgraphCriteriasByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getThinkgraphCriteriasByIds(team.id, ids)
  }

  return await getAllThinkgraphCriterias(team.id)
})