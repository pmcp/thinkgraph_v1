...
import { getAllThinkgraphNotes, getThinkgraphNotesByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getThinkgraphNotesByIds(team.id, ids)
  }

  return await getAllThinkgraphNotes(team.id)
})